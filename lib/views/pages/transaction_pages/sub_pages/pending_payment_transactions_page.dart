...
class PendingPaymentTransactionsPage extends StatelessWidget {
  const PendingPaymentTransactionsPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    List<TransactionModel> transactions = provider.getTransactionsByStatus("En attente");
    return Scaffold(
