...
class CanceledTransactionsPage extends StatelessWidget {
  const CanceledTransactionsPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    List<TransactionModel> transactions = provider.getTransactionsByStatus("Annulée");
    return Scaffold(
