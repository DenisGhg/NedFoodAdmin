...
class InPreparationOrdersPage extends StatelessWidget {
  const InPreparationOrdersPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    List<OrderModel> orders = provider.getOrdersByStatus("En préparation");
    return Scaffold(
